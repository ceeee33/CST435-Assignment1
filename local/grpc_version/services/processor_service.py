...
# UPLOADER_ADDR = os.getenv("UPLOADER_ADDR", "local-grpc-uploader:50040")
# NOISE_ADDR = os.getenv("NOISE_ADDR", "local-grpc-noise:50041")
# BACKGROUND_ADDR = os.getenv("BACKGROUND_ADDR", "local-grpc-background:50042")
# CLASSIFIER_ADDR = os.getenv("CLASSIFIER_ADDR", "local-grpc-classifier:50043")
